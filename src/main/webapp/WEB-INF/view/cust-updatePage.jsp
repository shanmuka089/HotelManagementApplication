...
<h1 align="center" id="title">Update User</h1>
<form:form action="/cust-updateProcess" method="post" modelAttribute="customer">
	<div align="center" id="page">
		<table cellpadding="10px" cellspacing="12px">
			<tr>
			<td><label for="id">registered id</label></td>
			<td><form:input type="text" path="customer_id" id="id"/>
			<form:errors  path="customer_id" class="error"/></td>
			</tr>
			<tr>
			...
			<td><form:input path="customer_password" id="pass" />
			<form:errors path="customer_password" class="error"/>
			</td>
			</tr>
			<tr>
			<td colspan="2" align="center"><input type="submit" class="btn btn-success" value="Update"/>

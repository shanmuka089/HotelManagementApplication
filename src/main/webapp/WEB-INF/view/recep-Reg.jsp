...
<body>
	...
	<h1>Receptionist Registration</h1>
		<form:form action="/recepRegProcess" modelAttribute="receptionist">
			<div class="container">
				<div class="row">
				...
				<div class="row">
					...
					<input type="submit" class="btn btn-success bt" value="Register"> <input type="reset" class="btn btn-info bt"
						value="Reset">
					</div>
				</div>
				</div>

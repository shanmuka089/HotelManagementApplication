...
<div align="center" class="card room" style="width: 500px;">
	<h1>Update Room</h1>
	<form:form action="${request.getContextPath()}/roomUpdateProcess" modelAttribute="room">
		<table cellpadding="10px"; cellspacing="10px";>
			...
			<tr>
			<td><label for="cost">Room Booked</label></td>
			<td>
			<form:radiobutton path="in_use" class="rad" value="true"/>
			true 
			<form:radiobutton path="in_use" class="rad2" value="false"/>
			false
			<form:errors class="error" path="in_use"/>
			</td>
			</tr>
